...
namespace SSX_Library.FileHandlers
{
    internal class BNKAudioCode
    {
        //Code taken directly from the UI Side of things needs to be updated to work with no UI

        //Extracts and Rebuilds the BNK audio format
        //May need a toggle for which SX version to use as there were large issues with certain games not working right
